...
The easiest way to download, build & install the Lua/APR binding is to use [LuaRocks](http://luarocks.org/):
    ...
    $ luarocks install http://peterodding.com/code/lua/apr/downloads/lua-apr-0.9.23-1.rockspec
...
If you don't have LuaRocks installed the following shell commands should help you get started on UNIX:
    ...
    $   wget http://peterodding.com/code/lua/apr/downloads/lua-apr-0.9.23-1.zip
    $   unzip lua-apr-0.9.23-1.zip
    $   mv lua-apr-0.9.23-1 lua-apr
    $ fi
    $ cd lua-apr
 ...
 * **Multi threading** that's simple but provides the needed primitives for more complicated systems
 * **Incremental [MD5](http://apr.apache.org/docs/apr/trunk/group___a_p_r___m_d5.html) & [SHA1](http://apr.apache.org/docs/apr/trunk/apr__sha1_8h.html) hashing** (once this exists [apr.md5()](http://peterodding.com/code/lua/apr/docs/#apr.md5) and [apr.sha1()](http://peterodding.com/code/lua/apr/docs/#apr.sha1) can be implemented on top of it)
